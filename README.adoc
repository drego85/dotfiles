...
* link:bin/odt-to-adoc[*odt-to-adoc*]: a small Python script that converts a
subset of an ODT file to pure text file.
...
* link:bin/md2adoc[*md2adoc*]: a small GAWK script that converts a Markdown file
to Asciidoc.
